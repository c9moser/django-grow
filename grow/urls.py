...
growlog_patterns = [
     ...
     path("__hx__/growlog/add_plants/<int:pk>/",
          HxGrowlogAddPlantsView.as_view(),
          name="hx-growlog-plants-add"),
     path("__hx__/growlog/remove_plants/<int:pk>/",
     ...
     path("__hx__/growlog/entry_update/<int:pk>/",
          HxGrowlogEntryUpdateView.as_view(),
          name="hx-growlog-entry-update"),
     path("__hx__/growlog/entry_delete/<int:pk>/",
