...
from .views.strain import (
    ...
    HxStrainGrowlogsView,
    HxStrainMyGrowlogsView,
...
strain_patterns = [
    ...
    path("__hx__/strain/<int:pk>/delete/", HxStrainDeleteView.as_view(), name="hx-strain-delete"),
    path("__hx__/strain/<int:strain>/add_to_stock/<int:feminized>/",
    ...
    path("__hx__/strain/<int:strain>/remove_from_stock/<int:feminized>/",
         HxStrainRemoveFromStockView.as_view(),
         name="hx-strain-remove-from-stock"),
    path("__hx__/strain/<int:strain_pk>/my_growlogs/",
         HxStrainMyGrowlogsView.as_view(), name="hx-strain-my-growlogs"),
    path("__hx__/strain/<int:strain_pk>/growlogs/",
          HxStrainGrowlogsView.as_view(),
          name="hx-strain-growlogs"),
    path("__hx__/strain/stock_notes/<int:pk>/",
         HxStrainStockNotesView.as_view(),
         name="hx-strain-stock-notes"),
    path("__hx__/strain/<int:pk>/translation/",
...
growlog_patterns = [
    ...
    path("__hx__/growlog/<int:growlog_pk>/add_seeds/filter-strains/",
         HxGrowlogAddSeedsStrainFilterView.as_view(),
         name="hx-growlog-seeds-add-filter-strains"),
    ...
    path("__hx__/growlog/<int:pk>/permission_update/",
         HxGrowlogPermissionsUpdateView.as_view(),
         name="hx-growlog-permission-update"),
